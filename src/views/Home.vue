  ...
  <div class="home">
    <div class="main-hero">
      ...
      <div class="animation">
        ...
        <img src="../assets/shape2.svg" height="" width="" class="shape2" /><img
    ...
    <div id="fund" class="fund-sec">
      <div class="fund-box">
        ...
        <p class="txt">
          With no sector, cap limits, or complex structures. We have the liberty
          to explore partnering with founders that have an appetite for enormous
          growth and building companies that are meaningful to the world.<br />Agmen
          /ˈaɡ.men/, [ˈäɡmɛn] in latin, means progress &amp; movement, for us,
          it's not just a name, we think fast and act fast. We expect the same
          from our portfolio companies. Since its founding in 2021, Agmen has
          invested in 9 companies, including Glossier, Brain Corp, Tanium,
          Omada.
        </p>
    ...
    <div id="contact" class="contact-sec">
      <div class="cont-wrap">
        ...
        <p>
          Email: info@agmencapital.com <span class="cont-sep">|</span> Phone:
          0000000000
        </p>
        <a
