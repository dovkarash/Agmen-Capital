  ...
  <div class="home">
    <div class="main-hero">
      <div class="menu">
        ...
        <div class="menu-links-wrap" :class="{ open: openSideBar }">
          ...
          <button type="button" class="cta">Investor Login</button>
        </div>
      ...
      <div class="hero-txt-wrap">
        <div class="hero-inner-txt-wrap">
          ...
          <p class="txt26">
            We invest in companies that change a paradigm make a difference.
          </p>
        </div>
      </div>
      <div class="animation">
    ...
    <div class="info-box">
      <div class="num-wrap">
        ...
        <p class="under-num">Invested<br />since 2021</p>
      </div>
      <div class="num-wrap">
        <h3 class="color-num">9</h3>
        <!-- Make a rolling number -->
        <p class="under-num">Portfolio Companies</p>
      </div>
    </div>
    ...
    <div class="color-sec thesis">
      <div class="color-txt-wrap">
        <h3 class="main-head">What We Do</h3>
        <p class="txt26">
    ...
    <div id="fund" class="fund-sec">
      <div class="fund-box">
        ...
        <p class="txt">
          ...
          growth and building companies that are meaningful to the world.
          <br />Agmen /ˈaɡ.men/, [ˈäɡmɛn] in latin, means progress &amp;
