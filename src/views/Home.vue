<template >
  <div class="home">
    <div class="main-hero">
      ...
      <div class="hero-txt-wrap">
        <div class="hero-inner-txt-wrap">
          ...
          <p class="txt26">
            Empowering highly innovative companies reach the next level of
            growth
          </p>
        </div>
      </div>
    ...
    <div class="info-box">
      ...
      <div class="num-wrap">
        <h3 class="color-num">{{ companies.length }}</h3>
    ...
    <div id="fund" class="fund-sec">
      <div class="fund-box">
        ...
        <p class="txt">
          ...
          [ˈäɡmɛn] in latin, means progress &amp; movement,&nbsp;and this is
          exactly what we aim to create. Since its founding in 2021, Agmen has
          invested in {{ companies.length }} companies, including Glossier,
          Brain Corp, Tanium, Omada.
        </p>
