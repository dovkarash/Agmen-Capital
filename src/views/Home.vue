<template >
  <div class="home">
      ...
      <div class="hero-txt-wrap">
        <div class="hero-inner-txt-wrap">
          <h1 class="main-head left">
            <span class="small-title">We invest in</span>Innovation Growth &amp;
            Momentum
          </h1>
    ...
    <div class="info-box">
      <div class="num-wrap">
        <h3 class="color-num">$35Mil</h3>
        <p class="under-num">Deployed</p>
      </div>
      <div class="num-wrap">
        <h3 class="color-num">9</h3>
        <!-- Make a rolling number -->
        <p class="under-num">Investments</p>
      </div>
    </div>
    <div id="portfolio" class="portfolio">
      <div class="comps-wrap">
        ...
        <div v-for="company in companies" :key="company._id" class="comp-logo">
          <div class="popup-wrap" :class="{ open: openPopup === company._id }">
            <div class="popup">
              <div @click="openPopup = null" class="close-pop">
                <img src="../assets/close.svg" />
              </div>
              <img :src="company.logo.imageURL" class="pop-comp-logo" />
              <h3 class="mid-head">{{ company.name }}</h3>
              <div class="pop-txt-wrap">
                <div v-html="company.description" class="txt"></div>
                <a
                  class="txt bold"
    ...
    <div id="fund" class="fund-sec">
      <div class="fund-box">
        ...
        <p class="txt">
          With no sector, cap limits, or complex structures. We have the liberty to explore partnering with founders that have an appetite for enormous growth and building companies that are meaningful to the world.
          <br />Agmen /ˈaɡ.men/, [ˈäɡmɛn] in latin, means progress &amp; movement, for us, it's not just a name, we think fast and act fast. We partner with founders that share the same vision. Since its founding in 2021, Agmen has invested in 9 companies, including Glossier, Brain Corp, Tanium, Omada.
        </p>
        <img src="../assets/white-icon.svg" height width class="icon" />
      </div>
      <div class="backbox1 fund"></div>
      <div class="white-bot"></div>
      <img src="../assets/sanfrancisco.jpg" height width class="sanfar" />
    </div>
    <div class="managing-sec">
      <div class="managing-wrap">
        <div class="mang-side">
          <img src="../assets/Schmukler.jpg" height width class="profie" />
          <p
            class="txt26"
          >A visionary can’t help but take the risk because the impact is just too big not to pursue.</p>
          <p class="big-quote">"</p>
    ...
    <div id="contact" class="contact-sec">
      <div class="cont-wrap">
        <h3 class="main-head">Contact Us</h3>
        <form @submit.prevent="sendForm" v-if="formStatus != 'success'" class="cont-form">
          <input
            placeholder="Name"
            type="text"
            id="firstID"
          ...
          ></textarea>
          <input type="submit" id value="Submit" class="cont-input btn" />
        </form>
        ...
        <p>
          ...
          <span class="cont-sep">|</span> Phone: 213-556-6511
        </p>
        <a href="https://www.linkedin.com/company/agmencapital/" target="_blank" class="linkedin">
          <img src="../assets/linkedin.svg" height width />
        </a>
      </div>
      <div class="backbox1 fund cont"></div>
    </div>
    <div class="footer">
      ...
      <div class="footer-links-wrap">
        ...
        <router-link to="Termsofuse" class="footer-link">Terms of Use</router-link>
      </div>
    </div>
  </div>
</template>
